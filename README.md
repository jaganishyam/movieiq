...
1. Push these files to a **public GitHub repo** (keep `movies.csv` in the repo
   so the deployed app can find it).
2. Go to <https://share.streamlit.io> and sign in with GitHub.
3. Click **New app**, pick your repo, and set the main file to `MovieIQ.py`.
